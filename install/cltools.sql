...
--
-- Host: localhost    Database: cltools
-- ------------------------------------------------------
...
CREATE TABLE `listings` (
  ...
  `post_date` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `geotag` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2016-11-28 19:26:46
